...
import getContacts from '@salesforce/apex/HyperboliqDynamicRelListCtrl.getContactList';
...
export default class HyperboliqDynamicRelatedList extends LightningElement {
    @api recordId;
    ...
    @wire(getContacts, { parentRecordId: "$recordId" })
    contacts;
